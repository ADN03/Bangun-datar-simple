package com.example.muhammadadni.bangun_datar;
...
import com.example.ridorianto.bangun_datar.R;
...
public class persegi_panjang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p = (EditText) findViewById(R.id.sisi1);
        l = (EditText) findViewById(R.id.sisi2);
